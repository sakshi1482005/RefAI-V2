...
export const demoAnalysisSession: AnalysisSession = {
  ...
  trustCard: {
    ...
    scoreBreakdown: [
      { key: 'roleRequirementMatch', label: 'Role Requirement Match', weight: 30, score: 93, contribution: 28, reason: 'Required and preferred JD requirements are covered by resume evidence.' },
      { key: 'evidenceStrength', label: 'Evidence Strength', weight: 25, score: 92, contribution: 23, reason: 'Skills are supported by projects, internship use, and measurable outcomes.' },
      { key: 'projectExperienceRelevance', label: 'Project and Experience Relevance', weight: 20, score: 90, contribution: 18, reason: 'Project and internship descriptions align with the role responsibilities.' },
      { key: 'skillDepth', label: 'Skill Depth', weight: 15, score: 90, contribution: 14, reason: 'Core skills recur across role-connected project and internship evidence.' },
      { key: 'resumeEvidenceCompleteness', label: 'Resume Evidence Completeness', weight: 10, score: 80, contribution: 8, reason: 'Most observable evidence signals are present, with room for stronger chronology detail.' },
    ],
    scoreReasons: ['Role Fit is 94% from weighted requirement coverage.', 'Proof is 82% from repeated evidence.', 'Gap Score is 6% from unsupported requirements.', 'Overall Match is the rounded average of Role Fit and Proof.'],
